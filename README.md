...
```
docker run -it --rm -d -p 8080:443 --name hubs-main -v /mnt/d/works/mozilla-hub/metabooth/hubs/dist:/usr/share/nginx/html nginx
```

* Run Admin dist with NGINX docker image as static web
```
docker run -it --rm -d -p 8989:443 --name hubs-admin -v /mnt/d/works/mozilla-hub/metabooth/hubs/admin/dist:/usr/share/nginx/html nginx
```
