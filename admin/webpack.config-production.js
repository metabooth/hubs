...
module.exports = (env, argv) => {
  ...
  Object.assign(process.env, {
    ...
    CORS_PROXY_SERVER: ``,
    NON_CORS_PROXY_DOMAINS: `${localDevHost}, https://${localDevHost}, https://${localDevHost}:8080, https://${localDevHost}:8989, https://${localDevHost}:9090`,
    //FIXME BASE_ASSETS_PATH: `https://${localDevHost}:8989/`,
    BASE_ASSETS_PATH: `https://${localDevHost}/`,
